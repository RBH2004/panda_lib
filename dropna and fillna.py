...
data3=data.dropna(axis=1) #removes column with Nan data. similarly axis=0 removes row with Nan data
print(data3)
#
...
data6=data.fillna(method='bfill',axis=1) #fills the Nan values with data from the back column along the row
print(data6)

#we can also use ffill to get forward filling

#       pickup_year  pickup_month  pickup_day  ...  tip_amount  total_amount  payment_type
#0              1.0           1.0         1.0  ...       11.65         69.99           1.0
#1           2016.0           1.0         1.0  ...        8.00         54.30           1.0
#2           2016.0           1.0         1.0  ...        0.00         37.80           2.0
...
#changes the values in the orginal data

#       pickup_year  pickup_month  pickup_day  ...  tip_amount  total_amount  payment_type
#0             12.0          12.0           1  ...       11.65         69.99             1
#1           2016.0           1.0           1  ...        8.00         54.30             1
#2           2016.0           1.0           1  ...        0.00         37.80             2
#3           2016.0           1.0           1  ...        5.46         32.76             1
#4           2016.0           1.0           1  ...        0.00         18.80             2
